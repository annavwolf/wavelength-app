...
// Phase 4 self-serve §7 — read-only Team Meeting Agenda, filled for this team.
    ...
    <main className="flex-1">
      <div className="w-full max-w-2xl mx-auto px-6 pt-8 pb-20">
        ...
        <div className="mt-6 print:hidden">
          <Link href="/me/results/game-plan" className="text-sm text-[var(--color-navy)] underline">
            Open your Game Plan to fill in during the meeting →
          </Link>
        </div>
      </div>
    </main>
