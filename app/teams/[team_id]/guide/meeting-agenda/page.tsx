...
// Consultant preview of the Team Meeting Agenda.
  ...
  if (state === "not_ready" || !content) {
    return (
      <main className="flex-1 flex flex-col items-center justify-center px-6 py-24 text-center">
        <p className="text-[var(--color-grey)]">The meeting agenda hasn&apos;t been generated yet for this team.</p>
    ...
    <main className="flex-1">
      <div className="mx-auto w-full max-w-2xl px-4 pb-20 pt-6 sm:px-6 sm:pt-8">
        ...
        <div className="mt-6 print:hidden">
          <Link href={`/teams/${teamId}/guide/game-plan`} className="inline-flex min-h-11 items-center text-sm text-[var(--color-navy)] underline">
            Open the Game Plan to fill in during the meeting →
          </Link>
        </div>
      </div>
    </main>
